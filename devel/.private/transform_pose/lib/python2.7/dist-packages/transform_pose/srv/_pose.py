...
"""autogenerated by genpy from transform_pose/poseRequest.msg. Do not edit."""
import sys
...
class poseRequest(genpy.Message):
  ...
  _type = "transform_pose/poseRequest"
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from transform_pose/poseResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class poseResponse(genpy.Message):
  _md5sum = "271cb12677c4cd9bccbc642cd9258d1f"
  _type = "transform_pose/poseResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """geometry_msgs/Pose2D pose
...
def _get_struct_3d():
    ...
    return _struct_3d
class pose(object):
  _type          = 'transform_pose/pose'
  _md5sum = 'e87f7e096f6ac40f3431dc20e102fbb8'
